...
target = ${parameters.targetNamespace}.${parameters.targetClassName}2
symbolic.method = ${parameters.targetNamespace}.${parameters.targetClassName}2.run(${parameters.symbolicParameters})
