...
if [ "$fuzzType" == "uniform" ]; then
  ...
  resultFile="ResultTest"$fuzztime".txt"
...
# "ModDiff/Eq/Comp"
# "ModDiff/Eq/Const"
# "ModDiff/Eq/LoopMult10" #1
# "ModDiff/NEq/LoopMult10" #2
# "ModDiff/Eq/LoopMult15" #3
# "ModDiff/NEq/LoopMult15" #4
# "ModDiff/Eq/LoopMult2"
# "ModDiff/NEq/LoopMult2"
# "ModDiff/Eq/LoopMult20" #5
# "ModDiff/NEq/LoopMult20" #6
